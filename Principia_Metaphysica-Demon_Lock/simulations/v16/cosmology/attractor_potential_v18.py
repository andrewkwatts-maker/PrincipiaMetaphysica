...
PHYSICAL PREDICTIONS:
    ...
    2. Dark energy EoS: w_0 = -0.980 (thawing quintessence)
...
class AttractorPotentialV18(SimulationBase):
    ...
    late-time acceleration with equation of state w_0 = -0.980.
    """
    ...
    def __init__(self):
        ...
        self._metadata = SimulationMetadata(
            ...
            description=(
                ...
                "Predicts thawing quintessence with w_0 = -0.980, w_a ~ 0.1. "
    ...
    def get_formulas(self) -> List[Formula]:
        ...
        return [
            ...
            Formula(
                id="w0-attractor-v18",
                label="(5.6)",
                latex=r"w_0 = -1 + \frac{2}{3}\epsilon_{\rm eff} + \delta_{\rm Ricci} \approx -0.980",
                plain_text="w_0 = -1 + (2/3)*epsilon_eff + delta_Ricci ~ -0.980",
                category="DERIVED",
                description=(
        ...
        return [
            ...
            Parameter(
                ...
                description=(
                    ...
                    "Predicts w_0 = -0.980 (thawing quintessence)."
                ),
    ...
    def get_section_content(self) -> Optional[SectionContent]:
        ...
        return SectionContent(
            ...
            abstract=(
                ...
                "This potential predicts thawing quintessence with w_0 = -0.980 and "
            ...
            content_blocks=[
                ...
                ContentBlock(
                    ...
                    content=(
                        "The attractor dynamics predict w_0 = -0.980 with w_a ~ 0.1. "
