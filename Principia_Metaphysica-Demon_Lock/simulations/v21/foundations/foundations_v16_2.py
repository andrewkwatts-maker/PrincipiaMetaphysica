...
class FoundationsV16_2(SimulationBase):
    ...
    def get_section_content(self) -> Optional[SectionContent]:
        ...
        content_blocks = [
            ...
            ContentBlock(
                ...
                content=(
                    ...
                    "26D(24,1) potential. At this level, the 'Fine-Structure Constant' and the "
        ...
        return SectionContent(
            ...
            title="Foundations of Dimensional Descent",
            abstract="The 26D(24,1) ancestral bulk with Euclidean bridge, OR reduction, dual shadows, G2 manifold, and 6D→4D projection.",
