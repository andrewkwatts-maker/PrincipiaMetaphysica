...
"""
SimulateTheory_ExtraDimTuning_V3.py - Extra Dimension Influence Parameter Tuning
...
CRUCIAL PHYSICS MODIFICATION (V3):
---------------------------------
The sign of the correction to 1/α_GUT has been REVERSED. This is necessary because
the optimizer requires a positive (α₄ + α₅) for w₀ and θ₂₃, but this previously
increased the proton lifetime (τₚ). The new positive sign ensures a positive (α₄ + α₅)
will now REDUCE τₚ, resolving the primary tension.
...
print("=" * 80)
print("PRINCIPIA METAPHYSICA - EXTRA DIMENSION TUNING SIMULATION (V3)")
print("Addressing τₚ Tension by Reversing Sign of Δ(1/α_GUT)")
print("=" * 80)
print()
...
# ==============================================================================
# FUNCTIONS: THEORY PREDICTIONS (PHYSICS MODIFIED HERE)
# ==============================================================================
...
def compute_alpha_GUT(alpha_4, alpha_5):
    ...
    V3 MODIFICATION: Sign of delta_alpha reversed to POSITIVE.
    This ensures that a positive (α₄ + α₅) increases 1/α_GUT, which then
    REDUCES the proton lifetime (τₚ ∝ 1/α_GUT²).
    """
    alpha_GUT_inv_base = 24.68
    
    # Extra dimension modifies running via KK tower
    # Changed from -0.5 to +0.5 to resolve τₚ tension
...
# ==============================================================================
# OBJECTIVE FUNCTION: MINIMIZE DEVIATIONS FROM TARGETS (WEIGHTING RETAINED)
# ==============================================================================
...
def objective_function(params):
    ...
    Weights retained from V2: θ₂₃ penalty weight = 2.0.
    """
    ...
    # Increased weight for Neutrino Mixing (retained from V2)
...
def compare_predictions(alpha_4_base, alpha_5_base, alpha_4_opt, alpha_5_opt):
    ...
    chi2_base = print_results(alpha_4_base, alpha_5_base, "BASELINE")
    ...
    if alpha_4_opt is not None:
        ...
        print("IMPROVEMENTS (Relative to Baseline V2):")
        print("-" * 80)
...
if __name__ == '__main__':
    ...
    # Save grid results
    df_grid.to_csv('extra_dim_tuning_grid_v3.csv', index=False)
    print(f"✓ Grid results saved to 'extra_dim_tuning_grid_v3.csv'")
    print()
    ...
    print("=" * 80)
    print("SUMMARY & RECOMMENDATIONS (V3)")
    print("=" * 80)
    print()
    ...
    if alpha_4_opt is not None:
        ...
        print()
        print("Try exploring grid results in 'extra_dim_tuning_grid_v3.csv'")
