...
class FormulasRegistry:
    ...
    HEBREW_SYMBOL_REGISTRY = {
        ...
        "barbelo_modulus": {"hebrew": "Qoph-Samekh-Gimel", "hebrew_char": "קסג", "gematria": 163, "value": 163, "old_name": "odowd_bulk_pressure", "symbol": r"\mathcal{\text{ק}}^{\text{סג}}", "scientific_name": "Ancestral Bulk Pressure Modulus", "gnostic_name": "Barbelo Modulus", "rationale": "Calligraphic Qoph (ק) with סג (63) superscript = 163. Barbelo is the first emanation, the Divine Mother of the Pleroma. 163 sterile residues stabilize the higher-dimensional manifold: (7 × 24) - 5 = 163. Seesaw heavy M_R ~10^{12} GeV."},
        ...
        "sophian_modulus": {"hebrew": "Qoph-Kaf-He", "hebrew_char": "קכה", "gematria": 125, "value": 125, "old_name": "visible_sector", "symbol": r"\mathcal{\text{ק}}^{\text{כה}}", "scientific_name": "Visible Residue Modulus", "gnostic_name": "Sophia Assembly", "rationale": "Calligraphic Qoph (ק) with כה (25) superscript = 125. The 125 Standard Model parameters visible through Sophia's window (5³ = 125 = manifest volume)."},
        "qedem_chi_sum": {"hebrew": "Qedem", "hebrew_char": "קדם", "gematria": 144, "value": 144, "old_name": "chi_eff_total", "symbol": r"\mathcal{\text{ק}}^{\text{דם}}", "scientific_name": "Total Euler Characteristic", "gnostic_name": "Qedem Chi", "rationale": "Calligraphic Qoph (ק) with דם (44) superscript = 144. Qedem (קדם = 144) means 'ancient' or 'primordial.' Total χ_eff across both shadows: 72 + 72 = 144. Ancestral unity."},
