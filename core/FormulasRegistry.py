...
class FormulasRegistry:
    ...
    HEBREW_SYMBOL_REGISTRY = {
        ...
        "barbelo_modulus": {"hebrew": "Qoph-Samekh-Gimel", "hebrew_char": "קסג", "gematria": 163, "value": 163, "old_name": "odowd_bulk_pressure", "symbol": r"\mathcal{M}^{\text{ק}}_{\text{סג}}", "scientific_name": "Ancestral Bulk Pressure Modulus", "gnostic_name": "Barbelo Modulus", "rationale": "M for Modulus with Qoph (ק) superscript denoting the mirror/hidden domain. סג = 63 subscript completes 163. Barbelo is the first emanation, the Divine Mother of the Pleroma. 163 sterile residues stabilize the higher-dimensional manifold: (7 × 24) - 5 = 163. Seesaw heavy M_R ~10^{12} GeV."},
        ...
        "sophian_modulus": {"hebrew": "Qoph-Kaf-He", "hebrew_char": "קכה", "gematria": 125, "value": 125, "old_name": "visible_sector", "symbol": r"\mathcal{M}^{\text{ק}}_{\text{כה}}", "scientific_name": "Visible Residue Modulus", "gnostic_name": "Sophia Assembly", "rationale": "M for Modulus with Qoph (ק) superscript denoting the normal/visible domain. כה = 25 subscript completes 125. The 125 Standard Model parameters visible through Sophia's window (5³ = 125 = manifest volume)."},
