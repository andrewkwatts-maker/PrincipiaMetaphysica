...
migration and the four-domain peer-review cycle; refreshed 2026-09-02. Every
...
**Build health at time of writing:** 1677 tests pass · prose-drift 0 ·
...
3. **Convert declarative gates** (2.1) — biggest integrity win per unit
   effort; 14 gates still assert rather than compute, and 31 more have no
   evaluation record at all.
