...
This report analyzes all cosmological formulas in the Principia Metaphysica framework to determine the correct chi_eff value (72 vs 144) for each formula, based on simulation findings and peer review consultation.
