...
The Principia Metaphysica citation system provides dynamic, interactive citations that link to the references database. Citations are loaded from `AutoGenerated/json/references.json` and provide hover tooltips with full reference details.
...
- Loads references from `AutoGenerated/json/references.json`
...
References in `AutoGenerated/json/references.json`:
