...
- **Data Sources**:
  ...
  - Fallback: Individual JSON files in `AUTO_GENERATED/json/`
    - `simulations.json`
    - `parameters.json`
    - `statistics.json`
...
- **Data Sources**:
  - Primary: `theory_output.json` (unified file)
  - Fallback: `AUTO_GENERATED/json/formulas.json`
...
- **Data Sources**:
  - Primary: `AUTO_GENERATED/json/sections.json`
...
2. `"AUTO_GENERATED/"` - AUTO_GENERATED folder
3. `"../"` - Parent directory (for files in subdirectories)
4. `"../AUTO_GENERATED/"` - Parent's AUTO_GENERATED folder
5. `"../../"` - Two levels up
6. `"../../AUTO_GENERATED/"` - Two levels up AUTO_GENERATED
...
- 🟢 **Green** = Success (loaded from specific path)
- 🟡 **Orange/Yellow** = Warning (trying fallback)
- 🔴 **Red** = Error (failed to load)
...
**Checklist**:
1. ✅ Run `python run_all_simulations.py --export` to generate JSON files
2. ✅ Check that `theory_output.json` or `AUTO_GENERATED/json/*.json` exist
3. ✅ Open browser console and look for error messages
4. ✅ Enable debug mode: `window.PM_DEBUG = true`
...
**Checklist**:
1. ✅ Check `window.PM_FORMULAS` exists: `console.log(window.PM_FORMULAS)`
2. ✅ Verify formula ID exists: `console.log(PMFormulaLoader.get('your-formula-id'))`
3. ✅ Check console for "Formula not found" errors
4. ✅ Verify formulas.json was generated: `ls AUTO_GENERATED/json/formulas.json`
...
4. Verify JSON files have new timestamps: `ls -la AUTO_GENERATED/json/`
...
├── js/
│   ├── pm-constants-loader.js     # Main data loader
│   ├── pm-formula-loader.js       # Formula loader
│   ├── pm-section-renderer.js     # Section renderer
│   └── pm-validation-stats.js     # Statistics calculator
├── AUTO_GENERATED/
│   ├── theory_output.json         # Unified output (primary)
│   └── json/
│       ├── simulations.json       # Simulation results
│       ├── formulas.json          # Mathematical formulas
│       ├── parameters.json        # Theory parameters
│       ├── sections.json          # Paper sections
│       ├── references.json        # Bibliography
│       └── statistics.json        # Summary statistics
├── test-loaders.html              # Loader test page
└── test-pm-stats.html             # Statistics test page
```
