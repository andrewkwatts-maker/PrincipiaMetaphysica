...
const FORMULA_DATABASE = {
    ...
    'w0': {
        ...
        experimental: 'DESI DR2: -0.83 ± 0.06 (0.38σ agreement)',
        occurrences: 123,
    ...
    'theta_12': {
        ...
        category: 'neutrinos',
        experimental: 'NuFIT 5.3: 33.41° ± 0.75° (0.22σ agreement)',
        occurrences: 18,
    ...
    'theta_23': {
        ...
        longDescription: 'PMNS atmospheric angle - EXACT MATCH with experiment',
        category: 'neutrinos',
        experimental: 'NuFIT 5.3: 47.2° (0.00σ - EXACT)',
        occurrences: 19,
        usedIn: ['fermion-sector', 'predictions', 'paper'],
        validated: true,
        exactMatch: true
    ...
    'theta_13': {
        ...
        category: 'neutrinos',
        experimental: 'NuFIT 5.3: 8.57° (0.00σ - EXACT)',
        occurrences: 17,
        usedIn: ['fermion-sector', 'predictions', 'paper'],
        validated: true,
        exactMatch: true
    ...
    'delta_CP': {
        ...
        category: 'neutrinos',
        experimental: 'NuFIT 5.3: 197° ± 26° (0.09σ agreement)',
        occurrences: 16,
        usedIn: ['fermion-sector', 'predictions', 'paper'],
        validated: true
    },
    ...
    'tau_p': {
        ...
        longDescription: 'Central prediction for proton decay lifetime from SO(10) GUT via dimension-6 operators',
