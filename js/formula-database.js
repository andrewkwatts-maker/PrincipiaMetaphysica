...
const FORMULA_DATABASE = {
    ...
    'w0': {
        ...
        longDescription: 'Present-day equation of state parameter derived from effective dimension D_eff = 12.589 (v12.7: 0.01% error - perfect match with DESI DR2)',
        category: 'cosmology',
    ...
    'tau_p': {
        ...
        longDescription: 'Geometric prediction for proton decay lifetime from SO(10) GUT via dimension-6 operators (v12.7 geometric value)',
