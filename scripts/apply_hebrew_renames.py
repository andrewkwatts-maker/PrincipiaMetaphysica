...
RENAMES = {
    ...
    'b3': ('elder_vessels', 24, 'Kad', 'Elder Vessels', 'G2 cycle container'),
    ...
    'shadow_sector': ('demiurgic_gates', 135, 'Kalah', 'Demiurge Gates', 'Normal entry portals'),
...
HEBREW_REGISTRY = '''
    ...
    HEBREW_SYMBOL_REGISTRY = {
        ...
        "elder_vessels": {"hebrew": "Kad", "gematria": 24, "value": 24},
        "horos_limit": {"hebrew": "Kaz", "gematria": 27, "value": 27},
        "mephorash_chi": {"hebrew": "Av", "gematria": 72, "value": 72},
        "demiurgic_gates": {"hebrew": "Kalah", "gematria": 135, "value": 135},
