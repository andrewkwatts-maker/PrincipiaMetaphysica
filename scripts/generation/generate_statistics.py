...
STATISTICAL_RIGOR_FILE = os.path.join(PROJECT_ROOT, "AutoGenerated", "statistical_rigor_report_v24.json")
...
def extract_sigma_deviations_from_statistical_report(report_data: Dict[str, Any]) -> List[float]:
    """Extract sigma deviations from statistical_rigor_report_v24.json."""
    sigma_deviations = []
...
def generate_statistics() -> Dict[str, Any]:
    ...
    if statistical_report:
        ...
        print(f"  - Found {len(report_sigmas)} sigma deviations from statistical_rigor_report_v24.json")
