...
- ANCESTRAL: Original 25D bosonic frame (Level 0)
...
class DimensionalSSOTValidator:
    ...
    # Chain: 25D(24,1) → [Sp(2,R)] → 13D(12,1) → [G2(7,0)] → 6D(5,1) → [KK] → 4D(3,1)
    DIMENSIONAL_CHAIN = {
        # Level 0: ANCESTRAL (25D Bosonic) - Signature (24,1)
        "D_ancestral_total": 25,
