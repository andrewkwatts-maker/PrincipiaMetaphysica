...
SIMULATION_MAPPING = {
    ...
    "g2-manifold.png": "simulations/v21/geometric/g2_geometry_v16_0.py",
    "gauge-fixing-time.png": "simulations/renormalization_group_runner_fixed.py",
    "parameter-space.png": "simulations/v21/neutrino/neutrino_mixing_v16_0.py",
    "octonionic-triality-ckm-pmns.png": "simulations/v21/fermion/ckm_matrix_v16_0.py",
    "ricci-flow-hubble-evolution.png": "simulations/v21/cosmology/dark_energy_thawing_v16_2.py",
    "cosmology-evolution-diagram.png": "simulations/v21/cosmology/s8_suppression_v16_1.py",
    "cmb-power-spectrum.png": "simulations/v21/cosmology/cosmology_intro_v16_0.py",
    "generation-count-consistency.svg": "simulations/v21/fermion/ckm_matrix_v16_0.py",
    "kk-spectrum-2d-grid.png": "simulations/v21/cosmology/cosmology_intro_v16_0.py",
    "cmb-bubble-parameter-space.png": "simulations/v21/cosmology/cosmology_intro_v16_0.py",
    "heterogeneous-brane-structure.svg": "simulations/derivations/g2_geometry_derivations.py",
    "clifford-algebra-structure.png": "simulations/v21/fermion/ckm_matrix_v16_0.py",
    "so10-breaking.png": "simulations/v21/fermion/ckm_matrix_v16_0.py",
    "yukawa-couplings.png": "simulations/v21/fermion/ckm_matrix_v16_0.py",
    "validation-dashboard.svg": "simulations/validation/CERTIFICATES_v16_2.py",
    "swampland-criteria.png": "simulations/v21/cosmology/cosmology_intro_v16_0.py",
    "experimental-signatures.png": "simulations/v21/cosmology/cosmology_intro_v16_0.py",
}
