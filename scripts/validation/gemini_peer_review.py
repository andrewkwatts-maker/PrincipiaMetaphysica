...
class SimulationAnalyzer:
    ...
    def analyze_file(self, file_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            module_path = str(rel_path).replace(os.sep, '.').replace('/', '.').rstrip('.py')
    ...
    def get_all_simulation_files(self) -> List[Path]:
        ...
        sim_dir = PROJECT_ROOT / "simulations" / "v23"
        files = []
...
def get_theory_context() -> str:
    ...
    context = f"""Principia Metaphysica v23
    ...
    if files:
        ...
        for i, fpath in enumerate(files, 1):
            ...
            try:
                ...
                # Save markdown report next to simulation file
    ...
    if args.paper_review:
        ...
        if args.dry_run:
            ...
            try:
                ...
                # Save paper review
                paper_path = PROJECT_ROOT / "AutoGenerated" / "gemini_paper_review.json"
