...
# Add paths for imports (file is in scripts/validation/, project root is 2 levels up)
_PROJECT_ROOT = Path(__file__).resolve().parent.parent.parent
sys.path.insert(0, str(_PROJECT_ROOT))
sys.path.insert(0, str(_PROJECT_ROOT / "simulations"))
...
def run_all_audits():
    ...
    # SAVE AUDIT LOG
    # ==========================================================================
    output_dir = _PROJECT_ROOT / "zenodo_package" / "05_Verification"
