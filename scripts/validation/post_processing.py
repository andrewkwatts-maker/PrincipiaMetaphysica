...
Usage:
    from scripts.validation.post_processing import generate_full_report
    ...
    from scripts.validation.post_processing import validate_theory_output
...
# Add project root to path for imports (file is in scripts/validation/)
