#!/usr/bin/env python3
"""
DEPRECATED (v14.1): Use run_all_simulations.py in the root directory instead.

Run All Simulations and Generate Single Source of Truth (v12.5)
================================================================

DEPRECATION NOTICE:
This script is DEPRECATED as of v14.1. It uses old v8.4-v12.5 simulations
that have been superseded by the v13.0+ geometric simulations.

Use the new run_all_simulations.py in the root directory which:
- Uses only canonical v13.0+ simulations
- Gets values from config.py (single source of truth)
- Validates against PDG 2024, NuFIT 6.0, DESI DR2
