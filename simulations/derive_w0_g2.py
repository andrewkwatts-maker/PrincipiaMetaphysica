...
if __name__ == "__main__":
    ...
    print(f"  α₄ = {alpha4:.6f}")
    print(f"  α₅ = {alpha5:.6f}")
    print(f"  α₄ + α₅ = {alpha4 + alpha5:.6f}")
    print()
    print(f"Effective dimension: d_eff = 12 + 0.5×(α₄ + α₅) = {d_eff:.6f}")
    print()
    print(f"Dark energy w₀ = -(d_eff - 1)/(d_eff + 1) = {w0:.6f}")
    print()
    print(f"  Target: w₀ ≈ -0.8528 (DESI DR2)")
    print(f"  PM geometric: w₀ = {w0:.6f}")
