...
using SHA-256 and timestamped with git commit information to establish priority
of discovery.
...
class DiscoveryHashRegistry:
    ...
    def compute_prediction_hash(self, prediction_data: Dict[str, Any]) -> str:
        """
        Compute SHA-256 hash of a prediction.

        The hash is computed over the canonical JSON representation to ensure
        reproducibility. The hash proves that this exact prediction was made
        at this exact time.
    ...
    def create_discovery_registry(self) -> Dict[str, Any]:
        ...
        for pred in predictions:
            ...
            entry = {
                ...
                "verification": {
                    ...
                    "reproducible": True,
                    "instructions": "Hash the 'prediction' field using SHA-256 to verify"
                }
            }
        ...
        registry = {
            ...
            "verification_protocol": {
                ...
                "step_4": "Compute SHA-256 hash of canonical JSON (sorted keys)",
