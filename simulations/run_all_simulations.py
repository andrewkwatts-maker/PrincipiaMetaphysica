...
try:
    from simulations.validation.unitary_filter_legacy import UnitaryFilterSimulation, UnitaryFilter
...
class SimulationRunner:
    ...
    def _run_eml_cross_check(self) -> None:
        ...
        """
        try:
            from simulations.core.eml_cross_check import (
                check_simulation,
        ...
        if not EML_AVAILABLE:
            print("[EML] eml_math not installed — skipping EML cross-check")
            return
        ...
        for sim in all_simulations:
            try:
                ...
                from simulations.core.eml_cross_check import SimulationCheck
    ...
    def _generate_visualizations(self) -> None:
        ...
        try:
            ...
            from simulations.visualizations.certificate_dashboard import (
        ...
        try:
            ...
            from simulations.visualizations.four_pattern_orthogonality import (
        ...
        try:
            ...
            from simulations.visualizations.torsion_funnel import generate_torsion_funnel
