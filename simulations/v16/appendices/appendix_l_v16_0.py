    ...
    def get_section_content(self) -> Optional[SectionContent]:
        ...
        return SectionContent(
            ...
            content_blocks=[
                    ...
                    content={
                        ...
                        "rows": [
                            ...
                            },
                            {
                                "parameter": "D_shadow",
                                "value": "13",
                                "formula": "Sp(2,ℝ): (24,2) → (12,1)",
                                "status": "Exact",
                                "param_ref": "dimensions.D_AFTER_SP2R"
                            },
                            {
                                "parameter": "D_G₂",
                                "value": "7",
                ...
                ContentBlock(
                    type="paragraph",
                    content="Step 2: Sp(2,ℝ) Quotient"
                ),
                ContentBlock(
                    type="paragraph",
                    content=(
                        "Two-time physics with signature (24,2) projects to 13D shadow space: "
                        "D_shadow = 26/2 = 13."
                    )
                ),
                ContentBlock(
            ...
            param_refs=[
                ...
                "compactification.m_KK_TeV",
                "gravitational_waves.eta_GW",
                "neutrino.mass_ordering",
                "fermions.m_t",
                "fermions.m_b",
                "fermions.m_tau",
            ]
