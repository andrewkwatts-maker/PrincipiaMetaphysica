...
class FluxIntegralChargeSimulation(SimulationBase):
    ...
    def __init__(self):
        ...
        self._b3 = _REG.b3  # = 24
        self._chi_eff = _REG.chi_eff  # = 144
            ...
            Formula(
                ...
                derivation={
                    "steps": [
                        ...
                        f"With b3={_REG.b3} cycles, get spectrum of charges"
                    ]
                },
                terms={
...
def run_flux_integral_simulation(verbose: bool = True) -> Dict[str, Any]:
    ...
    registry.set_param("topology.b3", _REG.b3, source="ESTABLISHED:FormulasRegistry", status="ESTABLISHED")
    registry.set_param("topology.chi_eff", _REG.chi_eff, source="ESTABLISHED:FormulasRegistry", status="ESTABLISHED")
    ...
    if verbose:
        ...
        print("\n--- Topology Inputs ---")
        print(f"  b3 (3-cycles):       {_REG.b3}")
        print(f"  chi_eff (Euler):     {_REG.chi_eff}")
