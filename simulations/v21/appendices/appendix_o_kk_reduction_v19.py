...
Principia Metaphysica dimensional chain: 26D -> 13D (Euclidean bridge) -> 7D (G2) -> 4D.
...
class AppendixOKKReduction(SimulationBase):
    ...
    def get_section_content(self) -> Optional[SectionContent]:
        ...
        content_blocks = [
            ...
            ContentBlock(
                type="formula",
                content=r"26D \xrightarrow{\text{Euclidean bridge}} 13D \xrightarrow{\text{G}_2} 7D \xrightarrow{\text{compact}} 4D",
            ...
            ContentBlock(
                ...
                content=(
                    "<ul>"
                    "<li><strong>26D -> 13D</strong>: Bosonic string critical dimension reduces via Euclidean bridge "
                    "and OR reconstruction, yielding the geometric skeleton</li>"
    ...
    def get_formulas(self) -> List[Formula]:
        ...
        return [
            ...
            Formula(
                ...
                label="(O.9)",
                latex=r"26D \xrightarrow{\text{Euclidean bridge}} 13D \xrightarrow{\text{G}_2} 7D \xrightarrow{\text{compact}} 4D",
                plain_text="Principia chain: 26D -> 13D -> 7D -> 4D",
                category="FOUNDATIONAL",
                description=(
                    "The Principia Metaphysica dimensional reduction chain. Each stage "
                    "preserves key structures: Euclidean bridge with OR reconstruction, G_2 holonomy, "
                    "and finally Standard Model gauge symmetry in 4D."
                ),
                terms={
                    "26D": "Bosonic string critical dimension",
                    "Euclidean bridge": "Analytic continuation via OR reconstruction",
