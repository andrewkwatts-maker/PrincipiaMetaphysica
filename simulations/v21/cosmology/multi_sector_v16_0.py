...
class MultiSectorV16(SimulationBase):
    ...
    def __init__(self, n_sectors: int = 4, sampling_position: float = 0.5):
        ...
        self.b3 = _REG.governing_elder_kad  # Associative 3-cycles (third Betti number) from SSOT
    ...
    def run(self, registry: PMRegistry) -> Dict[str, Any]:
        ...
        try:
            ...
            b3 = _REG.governing_elder_kad  # Default from SSoT registry
    ...
    def _compute_temperature_ratio(self, chi_eff: float) -> float:
        ...
        b3 = _REG.governing_elder_kad  # Associative 3-cycles from SSOT
