            ...
            Formula(
                ...
                derivation={
                    "steps": [
                        ...
                        f"With b3={_REG.elder_kads} cycles, get spectrum of charges"
                    ]
                },
                terms={
...
def run_flux_integral_simulation(verbose: bool = True) -> Dict[str, Any]:
    ...
    registry.set_param("topology.b3", _REG.elder_kads, source="ESTABLISHED:FormulasRegistry", status="ESTABLISHED")
    ...
    if verbose:
        ...
        print("\n--- Topology Inputs ---")
        print(f"  b3 (3-cycles):       {_REG.elder_kads}")
