    ...
    def get_formulas(self) -> List[Formula]:
        ...
        return [
            Formula(
                ...
                derivation={
                    "parent_formulas": ["higgs-quartic-coupling"],
                    "established_physics": ["standard-model-higgs"],
                    "steps": [
            ...
            Formula(
                ...
                derivation={
                    "parent_formulas": ["so10-matching", "sugra-loops"],
                    "established_physics": ["one-loop-renormalization"],
                    "steps": [
            ...
            Formula(
                ...
                derivation={
                    ...
                    "established_physics": ["supergravity-f-terms"],
                    "steps": [
            ...
            Formula(
                ...
                derivation={
                    "parent_formulas": ["z2-filter-mechanism"],
                    "established_physics": ["gut-higgs-multiplets"],
                    "steps": [
