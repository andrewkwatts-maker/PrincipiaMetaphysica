...
- 27D(24,1,2) = 12×(2,0) + S^{2,0} + (0,1) with OR reduction via R_perp operator
...
class SymplecticDescentValidator(SimulationBase):
    ...
    def _verify_dimensional_descent(self, b3: int) -> bool:
        """
        Verify the dimensional descent: 27D(24,1,2) = 12×(2,0) + S^{2,0} + (0,1) → 2×13D(12,1) shadows.
        ...
        """
        # 27D(24,1,2) starting point = 12×(2,0) + S^{2,0} + (0,1)
            ...
            content_blocks=[
                ...
                ContentBlock(
                    ...
                    content=(
                        ...
                        "3. 27D(24,1,2) = 12×(2,0) bridge pairs + S^{2,0} sampler data fields + (0,1) shared time\n\n"
    ...
    def get_formulas(self) -> List[Formula]:
        ...
        return [
            ...
            Formula(
                ...
                plain_text="27D(24,1,2) = 12×(2,0) + S^{2,0} + (0,1) → [R_perp] → 2×13D(12,1)",
                category="DERIVED",
                description=(
                ...
                derivation={
                    ...
                    "steps": [
                        "Start: 27D(24,1,2) = 12×(2,0) bridge pairs + S^{2,0} sampler data fields + (0,1) shared time",
