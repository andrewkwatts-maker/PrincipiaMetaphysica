...
class WolframValidator:
    ...
    def validate_formula(self, entry: ValidationEntry) -> ValidationEntry:
        ...
        """
        print(f"🔍 Validating: {entry.label}")
    ...
    def _extract_numeric(self, text: str) -> Optional[float]:
        ...
        match = re.search(r'[-+]?\d*\.?\d+(?:[eE][-+]?\d+)?', text.replace('×10^', 'e'))
        if match:
            try:
    ...
    def generate_proof_manifest(self, entries: List[ValidationEntry], output_path: str = None):
        ...
        print(f"\n✅ Proof manifest saved to: {output_path}")
...
def get_validation_registry() -> List[ValidationEntry]:
    ...
    Categories:
    - GEOMETRIC: Topological constants from b₃=24
    ...
    return [
        ...
        ValidationEntry(
            ...
            category="GEOMETRIC",
            theory_formula="k_gimel = b₃/2 + 1/π",
        ...
        ValidationEntry(
            ...
            category="GEOMETRIC",
            theory_formula="C_kaf = b₃(b₃-7)/(b₃-9)",
        ...
        ValidationEntry(
            ...
            category="GEOMETRIC",
            theory_formula="1/α_GUT = b₃ + 1/10 + 1/(5×b₃)",
            wolfram_query="24 + 1/10 + 1/(5*24)",
            pm_value=24.108333,
            notes="Derived from b₃"
        ),
        ...
        ValidationEntry(
            ...
            category="COSMOLOGY",
            theory_formula="H₀ = H_early × (1 + k_gimel/200)",
        ...
        ValidationEntry(
            ...
            label="Dark Energy w₀",
            category="COSMOLOGY",
            theory_formula="w₀ = -(d_eff - 1)/(d_eff + 1)",
        ...
        ValidationEntry(
            id="dm_ratio",
            label="Dark Matter Ratio Ω_DM/Ω_b",
            category="COSMOLOGY",
            theory_formula="Ω_DM/Ω_b = (T'/T)^4 × volume_ratio",
        ...
        ValidationEntry(
            ...
            label="GUT Scale",
            category="GAUGE",
            theory_formula="M_GUT = M_P × exp(-π × χ_eff / b₃)",
        ...
        ValidationEntry(
            ...
            category="GAUGE",
            theory_formula="sin²θ_W = 3/8 at M_GUT, runs to 0.2312",
            wolfram_query="3/8",
            pm_value=0.375,
        ...
        ValidationEntry(
            ...
            category="FERMION",
            theory_formula="τ_p ∝ M_GUT⁴/(α_GUT² m_p⁵) × S²",
        ...
        ValidationEntry(
            id="theta_12",
            label="Solar Mixing Angle θ₁₂",
            category="NEUTRINO",
            theory_formula="θ₁₂ = arcsin(√(1/3 + ε)) where ε from b₃",
        ...
        ValidationEntry(
            id="theta_23",
            label="Atmospheric Mixing θ₂₃",
            category="NEUTRINO",
            theory_formula="θ₂₃ = 45° + δ(b₃)",
        ...
        ValidationEntry(
            ...
            label="CP Phase δ_CP",
            category="NEUTRINO",
            theory_formula="δ_CP from G2 complex structure",
        ...
        ValidationEntry(
            ...
            category="QUANTUM",
            theory_formula="τ = ℏ/E_G where E_G from G2",
        ...
        ValidationEntry(
            ...
            category="MASTER_ACTION",
            theory_formula="Vol(X) = Vol(K3) × Vol(S³/Γ)",
...
if __name__ == "__main__":
    ...
    registry = get_validation_registry()
    print(f"\n📋 Loaded {len(registry)} formulas for validation\n")
    ...
    for status, count in sorted(status_counts.items()):
        emoji = {"VERIFIED": "✅", "CLOSE": "🔶", "MISMATCH": "❌", "ERROR": "⚠️"}.get(status, "❓")
