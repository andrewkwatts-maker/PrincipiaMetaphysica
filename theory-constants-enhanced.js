/**
 * Principia Metaphysica - Theory Constants (v12.8)
 * =================================================
 *
 ...
 *
 * Changelog:
 * - v9.0: Transparency data (fitted vs derived)
 * - v9.1: BRST proof results
 * - v10.0: Geometric derivations (alpha_4, alpha_5, chi_eff)
 * - v10.1: Neutrino mass matrix
 * - v10.2: All fermion matrices + CKM
 * - v11.0: Proton lifetime + Higgs mass
 * - v12.0: Final neutrino masses + KK graviton
 * - v12.8: Complete derivation chains + transparency report
 *
...
const PM = {
  ...
  "proton_decay": {
    ...
    "tau_p_median": 3.8491191861652884e+34,
    "tau_p_mean": 3.988607673856687e+34,
    "tau_p_std": 1.504358111055338e+34,
    "tau_p_lower_68": 2.436479404354665e+34,
    "tau_p_upper_68": 5.568897760920487e+34,
    "tau_p_lower_95": 1.4813677629381436e+34,
    "tau_p_upper_95": 7.243112258421179e+34,
    "tau_p_uncertainty_oom": 0.17555677029706884,
    "super_k_bound": 1.67e+34,
    "ratio_to_bound": 2.304861788122927
  },
  "pmns_matrix": {
    "theta_23": 45.0,
    ...
    "theta_23_error": 0.8026258178831768,
    "theta_12_error": 1.1871322020219166,
    "theta_13_error": 0.34992069599380743,
    "delta_cp_error": 28.06979334832089
  },
