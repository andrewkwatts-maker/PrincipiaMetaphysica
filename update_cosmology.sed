# Replace the simplified moduli potential with the full Update1-8 version
737,748{
737i\        <div class="interactive-formula" style="background: rgba(139, 127, 255, 0.1); border: 1px solid rgba(139, 127, 255, 0.2); border-radius: 12px; padding: 1.5rem; margin: 1.5rem 0;">\
